...
in this project I will create the backend of an online store. I will sift through the existing code to find bugs and edit pieces of code. 
...
As a user I want to be able to find all bugs in the backend of my website.
As  a user I want to be able to search by specifics such as product, price and ID. 
...
I would like to thank Ben, Shelby and Abirami!
